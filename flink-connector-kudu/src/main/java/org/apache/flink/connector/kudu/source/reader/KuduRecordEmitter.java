 ...
 */
public class KuduRecordEmitter<T> implements RecordEmitter<RowResult, T, KuduSourceSplit> {
    ...
    @Override
    public void emitRecord(RowResult element, SourceOutput<T> output, KuduSourceSplit splitState) {
